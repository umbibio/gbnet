...
cdef extern from "../libgbnet/include/ModelORNOR.h" namespace "gbn":
    ...
    cdef cppclass ModelORNOR:
        ModelORNOR() except +
        ModelORNOR( const network_t, const evidence_dict_t, unsigned int) except +
        ModelORNOR( const network_t, const prior_active_tf_set_t, unsigned int) except +
        ModelORNOR( const network_t, const evidence_dict_t, const prior_active_tf_set_t, unsigned int) except +
